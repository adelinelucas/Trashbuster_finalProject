...
import {getAllPost,getNumberOfPosts,getAllPostByUser, getPostById,createPost,updatePost,deletePost,getPostPicture } from '../controllers/Post.Controller.js'
...
router.route('/picture/:id').get(getPostPicture);
