    ...
    return (
        <div className="absolute w-full flex flex-col justify-center items-center bg-popUp z-10 top-[15%] h-min-screen py-12">
            <section className="w-full flex flex-col items-center justify-center">
                <article className="w-11/12 md:w-4/5 flex items-center my-3 justify-center relative ">
                    <div className='absolute top-[15px] right-[10%] lg:right-[18%] text-3xl cursor-pointer'>
                    <FaWindowClose  onClick={handelComment}/> 
                    </div>
                    <div className="bg-white border-8 border-brightYellow px-4 py-8 w-11/12 lg:w-8/12">
                        <form className="w-full" onSubmit={handelActionForm}>
                            <div className="mx-1 lg:mx-6 mb-2 px-1 lg:px-4 py-1 flex flex-col">
                            ...
                            {selectedPost ? '' : 
                                <div className="mx-1 lg:mx-6 mb-2 px-1 lg:px-4 py-1 flex flex-col">
                                    ...
                                    <FileBase type="file" multiple={false} onDone={({ base64 }) => setFormData({ ...formData, trash_picture: base64 })}  className="border-2 border-orangeV2 leading-normal w-full flex flex-col md:flex-row"/>
                                </div>
                            }
