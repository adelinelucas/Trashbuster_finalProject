...
const QandR = ({question, reponse}) => {
    ...
    return (
        <article className="w-5/12 bg-greenApple mx-10 px-8 py-4 flex justify-center border-4 border-lightGrey items-center  cardBoxShadow flex-col mb-8">
            <div>
                <header className='flex flex-row'>
                    ...
                    {showInfo && <p className="text-white text-md bg-darkGreen py-4 px-8">{reponse}</p>}
            </div>
        </article>
    );
};
